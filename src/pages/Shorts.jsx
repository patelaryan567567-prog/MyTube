...
import { MdShare, MdOutlineSubscriptions } from "react-icons/md";
...
export default function Shorts() {
  ...
  useEffect(() => {
    setLoading(true);
    fetchMore(true).then(() => {
      // scroll to startId if provided
      if (startId) {
        setShorts((prev) => {
          const idx = prev.findIndex((v) => v.id === startId);
          ...
          return (
            ...
            >
              ...
              <div style={s.playerWrap}>
                {activeIdx === idx ? (
                  <iframe
                    src={`https://www.youtube.com/embed/${v.id}?autoplay=1&loop=1&playlist=${v.id}&controls=1&modestbranding=1&rel=0`}
                    style={s.iframe}
